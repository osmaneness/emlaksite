  ...
  return (
    <>
      <div className={`${darkMode ? 'dark bg-black' : 'light bg-white'}`}>
        <section id='hero'
          className='w-[95%] h-[600px] m-auto bg-cover bg-center rounded-x1
          flex justify-center flex-col items-start lg:px-28 px-10 gap-7
          z-20' style={{ backgroundImage: `url(${heroimg})` }}>
          <h1 data-aos="zoom-in" className='
            text-6x1 text-white font-semibold
            lg:pr-[500px] pr-0 lg:leading-[700px] leading-[60px]'>
            Find your home </h1>
          <p data-aos="zoom-in" className='text-white text-x1 lg:pr-[500px]'>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Necessitatibus consectetur dolores consequatur dolorum, eum atque id provident rem neque ea.
          </p>
        </section>
      </div>
      ...
      <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} z-10`}>
        <div data-aos="zoom-in" id='form' className={`${darkMode ? 'dark bg-gray-800' : 'light bg-white'} lg:w-[70%] w-full m-auto grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-6 p-8 rounded-xl -mt-14`}>
          <div className='w-full'>
            ...
            <input type="text" placeholder='Enter an address, state, city' className='
            bg-white p-2 w-full mt-2 border-b-[1px] border-[#c9c7c1]'/>
          </div>
          <div className='w-full'>
            ...
            <select name="selectOption" id="selectOption"
              ...
              <option value="Option1">Kira</option>
              <option value="Option2">Satılık</option>
              <option value="Option3">Ofis</option>
            </select>
          </div>
          <div className='w-full'>
            ...
            <select name="selectOption" id="selectOption"
              ...
              <option value="Option1">Daire</option>
